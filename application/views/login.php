...
<style type="text/css">
	...
	.submit {
		...
		border-radius: 5em;
		color: #fff;
		background: linear-gradient(to right, firebrick, black);
		border: 0;
		padding-left: 40px;
		padding-right: 40px;
		padding-bottom: 10px;
...
<div class="main">
	...
	<form action="<?php echo base_url('auth/post_login') ?>" method="post" accept-charset="utf-8">
		...
		<br>
		<b ><p class="sign" align="center"> No Account ?</p></b><p align="center"> <a  href="<?php echo base_url('Auth/reg_view'); ?>"> Please Register</a></p>
